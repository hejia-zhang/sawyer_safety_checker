...
int main(int argc, char **argv) {
    ...
    ros::Publisher collision_pub = n.advertise<std_msgs::String>("sawyer_collision_avoidance/collision_state", 1000);

    CollisionGeometryPtr_t capsuleGeometry(new fcl::Capsuled(0.15, 0.24));
